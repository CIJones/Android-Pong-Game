...
public class Player2 {
	private Game game;
	private static final int Y = 730;								// Keeping the x-coordinates stationary. Restricting user to move in the x-direction
	private static final int WIDTH = 20;							// Constraints to make the coding easier.
	...
	/**
	 * 	@param graph2D
	 *	The paint(Graphics2D) method will display the paddle for the game, also repaints the paddle
	...
	public void keyPressed(KeyEvent e) {
		if (e.getKeyCode() == KeyEvent.VK_UP)						// By pressing the keys "W" and "S", the keyPressed method will be enabled, causing "xx" to equal 1
			xx = -5;
		if (e.getKeyCode() == KeyEvent.VK_DOWN)						// Pressing "W" will make the racket go up. Pressing "S" will make the racket go down
			xx = 5;
	}
